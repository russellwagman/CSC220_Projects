...
public class Wordle {
    ...
    public static void intro() { //made intro method like Mastermind to clean up the main and make it easier to call when a player wants to play again
        System.out.println("#########################################################");
        ...
        System.out.println("# For each guess, you receive a feedback. #");
        ...
        System.out.println("# h for show the history, and #");
